...
IDENTITY
- Pratyush Ingale, AI Engineer / Data Scientist, based in Dallas, TX
...
3. Throughline — multi-channel customer support intelligence; Claude summaries audited by a SECOND independent model for hallucinations (LLM-as-judge faithfulness evaluation); local clustering with DBSCAN + sentence-transformers. Demo: https://throughline.streamlit.app/
4. SentimentSense — business intelligence for small businesses; started with his mom's cafe (Cafe Mocha), expanded to a clothing boutique (Colours Boutique) and a tutoring center (Data Tech Solutions). Sentiment analysis + SARIMA/XGBoost 1-3 year financial forecasting. The project closest to his heart. Demo: https://sentimentsenseai.streamlit.app/
...
PHILOSOPHY
"AI systems that earn trust." Every system he builds has evaluation, abstention, or audit layers. He goes deep into a system, finds the gap, and ships the AI solution for it.
=== END PROFILE ===
`;
